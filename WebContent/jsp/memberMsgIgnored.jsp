...
<!-- css -->
<link rel="stylesheet" href="${contextPath }/css/memberMsgIgnored.css">
...
<div id="messageBoxWrapper">
	<div id="messageBoxSection">
		<div id="messageBoxTitleDiv">
			<span class="messageBoxTitle ignoredTitle">차단 목록&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="messageBoxTitle" style="float: right;">차단된 유저 ${viewData.totalCount}</span>
		</div>
...
<!-- 					<div class="messageBoxListTH">닉네임</div>	 -->
				</div>
				<c:forEach items="${viewData.msgIgnoredList}" var="member">
					<div class="messageBoxListBlock">
...
<%-- 						<div class="messageBoxListTD"><fmt:formatDate value="${message.message_writedate}" type="both" pattern="MM/dd"/></div> --%>
				...
				<div class="messageBoxListBlock">
					<input type="button" value="삭제" class="delete" onclick="delCheckedRelation('${member_id}')"> 
				</div>
				<div class="messageBoxListBlock">
