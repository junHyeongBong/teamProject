...
<!-- css -->
<link rel="stylesheet" href="${contextPath }/css/memberMyPageReply.css">
				...
				<div class="main col-lg-8 order-lg-2 ml-xl-auto" id="myPageMainFrame">
					<div class="wrap">
						...
						<div class="block clearfix">
							<h3 class="title">내가 쓴 리플</h3>
						</div>
						
						<div class="separator-2"></div>
						
						
						<table class="table table-striped" style="text-alind:center; boarder: 1px solid #ff0000">
							<thead>
								<tr>
									<th style="background-color: lightpink; text-align: center;">닉네임</th>
									<th style="background-color: #58D3F7; text-align: center;">리플내용</th>
									<th style="background-color: #58D3F7; text-align: center;">게시물번호</th>
									<th style="background-color: #58D3F7; text-align: center;">작성일</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${viewData }" var="board">
									<tr class="text-center">
										<td>${board.member_nick }</td>
										<td>${board.reply_content }</td>
										<td>${board.trip_board_num }</td>
										<td>${board.reply_regdate }</td>
