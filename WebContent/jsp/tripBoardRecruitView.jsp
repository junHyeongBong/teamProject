		...
		<div class="wrapper">
			...
			<form action="" method="post" class="form">
				...
				<div class="tripBoard">
					...
					<div class="tripInfo">
						...
						<div class="writerForm">
							<label>작성자</label><br>
							<img id="pf_image" alt="" src="readTripBoardWriterImg?writer_id=${tripBoard.member_id}">
							<input type="hidden" id="trip_board_member_id" name="trip_board_member_id" readonly="readonly" value="${tripBoard.member_id}">
				...
				<c:if test="${member_id==tripBoard.member_id}">
					<input class="lastButton" type="button" onclick="callRecruitList(${tripBoard.trip_board_num})" value="참가신청목록">
				...
				<c:if test="${!empty member_id}">
					<c:if test="${member_id != tripBoard.member_id}">
						<input class="lastButton" type="button" onclick="recruitApply()" value="참가신청">
				...
				<input class="lastButton" type="button" onclick="location.href='../common/tripBoardRecruitList'" value="목록">
				<br>
			</form>
			<br>
			<div class="recruitList">
				<table class="recruitListTable">
				</table>
			</div>
