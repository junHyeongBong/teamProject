    ...
    <div action="">
      <div class="container-fluid">
       ...
       <div class="row text-center">
      	  <div class="col-sm-12">
		      <a href="tripBoardBoolList" class="btn btn-info primary">목록보기</a>
		      ...
		      <c:if test="${member_id==trip_board.member_id}">
					<a href="tripBoardModifyForm?trip_board_num=${trip_board.trip_board_num}" class="btn btn-info primary">수정하기</a>
					<a href="tripBoardDelete?trip_board_num=${trip_board.trip_board_num}" class="btn btn-info primary">삭제</a>
		      </c:if>
	      </div>
	   </div>
      </div>
